   ...
   methods: {
    downloadPdf(_no,_locale){
      if(_no === 1) {
        ...
        if(_locale === 'KOR') window.open('https://drive.google.com/file/d/1EaHygFcjGFHKoEZg1Ysx2E3OCIMms4nE/view?usp=sharing');
        else if(_locale === 'ENG') window.open('https://drive.google.com/file/d/1WJb7V84rDg_h6DLjCYKbZlsjdU_KVrSR/view?usp=sharing');
      } else if(_no === 3) {
