            ...
            <section class="section fp-auto-height">
              <template v-if="$store.getters.getLocale === 'ENG'">
                ...
                <div class="main-char-ending">
                  <div class="fall">
                    <img
                      src="@/assets/m_images/char-fall.webp"
                      type="image/webp"
                    />
                  </div>
                </div>
              ...
              <template v-else>
                ...
                <div class="common-util">
                  <div class="head-title">
                    ...
                    <ul class="desc">
                      <li>
                        <strong>자격요건</strong> 모든 벨리곰 NFT 홀더 대상
                      </li>
                      <li><strong>운영플랜</strong> 1회 진행</li>
                    </ul>
                  </div>
                  <div class="content">
                    <ul>
                ...
                <div class="level-belly">
                  <div class="head-title">
                    ...
                    <h3>More Belly,<br />More Surprise</h3>
                    <p class="sub-txt">
                      계속 업데이트 될,<br />NFT만으로 누릴 수 있는 Belly
                      Benefit
                    </p>
                  </div>
                  <div class="level-list">
                    ...
                    <div class="box mega">
                      ...
                      <span class="condition">
                        운영플랜: <span class="divider">｜</span>시네마 시즌 내
                        3회
                      </span>
                      <div class="hide-mark">
                        <img
